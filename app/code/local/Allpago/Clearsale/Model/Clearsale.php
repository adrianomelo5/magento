    ...
    public function criarParametros($order) {
        ...
        try{
            ...
            $this->BillingData = array('ID' => $billingCustomerId,
                                         ...
                                         'Gender' => $customer->getGender()==1 ? 'M' : 'F',
                                         'Address' => array('Street' => preg_replace("/[^a-zA-Z0-9\s]/", "", $order->getBillingAddress()->getStreet(1)),
                                                            'Number' => preg_replace("/[^a-zA-Z0-9\s]/", "", $order->getBillingAddress()->getStreet(2)),
                                                            'Comp' => preg_replace("/[^a-zA-Z0-9\s]/", "", $order->getBillingAddress()->getStreet(3)),
                                                            'County' => preg_replace("/[^a-zA-Z0-9\s]/", "", $order->getBillingAddress()->getStreet(4)),
