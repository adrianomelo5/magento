...
class Allpago_Clearsale_Block_Adminhtml_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('status_clearsale', array(
            'header' => Mage::helper('sales')->__('Clearsale'),
            'index' => 'status_clearsale',
            'type'  => 'options',
            'width' => '70px',
            'options' => Mage::getSingleton('sales/order_config')->getStatuses(),
